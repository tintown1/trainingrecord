...
<div class="container"  >
    ...
    <form  action="save_department.php" method="post"  class="form-horizontal" role="form"   id="form" novalidate>
...
<main class="my-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">เพิ่มหน่วยงาน</div>
                        <div class="card-body">
                        <form  action="save_department.php" method="post" enctype="multipart/form-data" class="form-horizontal" role="form"id="form" novalidate>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="departmentName_tbl" class="form-control" name="departmentName_tbl" required>
