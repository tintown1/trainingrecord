...
<div class="container"  >
    ...
    <form   action="save_category.php" method="post"  class="form-horizontal" role="form"   id="form" novalidate>
...
<main class="my-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">เพิ่มประเภทการอบรม</div>
                        <div class="card-body">
                        <form  action="save_department.php" method="post" enctype="multipart/form-data" class="form-horizontal" role="form"id="form" novalidate>
                                <div class="form-group row">
                                    <label for="CategoryName_tbl" class="col-md-4 col-form-label text-md-right">ประเภทการอบรม</label>
                                    <div class="col-md-6">
                                        <input type="text" id="CategoryName_tbl" class="form-control" name="CategoryName_tbl" required>
