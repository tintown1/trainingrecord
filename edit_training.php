...
<form action="save_edittraining.php" method="post" enctype="multipart/form-data" class="form-horizontal" role="form"   id="form" novalidate>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <input class="form-control" data-validation="required" type="hidden" name="EmpID_tbl" placeholder="id" value="<?php echo $row['EmpID_tbl'];?>" >
