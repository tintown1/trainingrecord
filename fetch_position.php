...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.css">
  ...
  <body>
    ...
    <div class="row justify-content">
        ...
        <h1 class="card-title"> &nbsp;จัดการตำแหน่งงาน</h1>
        <div class="container">


<button type="button" name="submit" class="btn btn-primary btn-lg" onclick="window.location='insert_position.php'">เพิ่มตำแหน่งงาน</a></button>
<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" onclick="window.location='importposition.php'">ImportCSV</a></button>
<br><br>
        <table class="table table-info" id="example">
                <thead>
                    <tr class="info">
                        <th class="text-center" nowrap>id</th>
                        <th class="text-center" nowrap>ชื่อตำแหน่ง</th>
                   ...
                   <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>";
                                echo "<td><center>" . $row["p_id"]. "</td>";
                                echo "<td><center>" . $row["p_name"]. "</td>";
                                ...
                                ?>
                                  ...
                                  <input type="hidden" name="p_id" value="<?php echo $row['p_id']; ?>">
                                  <center><button type="submit" name="delete_btn" onclick="validateForm(this)"  class="btn btn-danger" value="<?php echo $row['p_id'];?>">ลบ</button>
                                  </form>
                                  </td>
...
function validateForm(e) {
    ...
    .then((willDelete) => {
        if (willDelete){
            document.location.href = 'delete_position.php?p_id='+e.value;
