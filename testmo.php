    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" method="POST" action="save_training_user.php" enctype="multipart/form-data" novalidate>
                <input class="form-control" id="EmpID_tbl" type="hidden" name="EmpID_tbl" value="<?php echo $ID;?>">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="date" class="form-control input-lg" name="trainingStartDate_tbl" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">วันสิ้นสุดฝึกอบรม</label>
                        <div>
                            <input type="date" class="form-control input-lg" name="trainingEndDate_tbl">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">หลักสูตร</label>
                        <div>
                            <input type="text" class="form-control input-lg" name="trainingCourse_tbl">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">สถานที่</label>
                        <div>
                            <input type="text" class="form-control input-lg" name="location_tbl">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">สถานที่</label>
                        ...
                        <?php 
	                                    ...
	                                    ?>
    					                <select class="input-lg" name="CategoryName_tbl" required>
                    ...
                    <label class="control-label">ประกาศนียบัตร</label>
                        <div>
                            <div class="radio">
                                ...
                                <label>
                                    <input type="radio"  value="มี" id="trainingCertificate_tbl" name="trainingCertificate_tbl">มี
                                    
                                </label>
                                <label>
                                    <input type="radio"  value="ไม่มี" id="trainingCertificate_tbl" name="trainingCertificate_tbl">ไม่มี
                                </label>
                            </div>
                        </div>
                    </div>
        ...
        <button type="button" class="button button5" onclick="window.location='excel_training_user.php'">ดาวน์โหลดลง excel</button>
        <button type="button" class="button button5" onclick="window.location='importcsv.php'">ImportCSV</a></button>
        <button type="button" class="button button5" onclick="window.open('print.php', '_blank');" >Print</a></button>
        <form target="_blank">
        </h1>
